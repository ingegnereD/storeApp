...
import PassRec from '../components/passRec'

const RecoverAct = ({access, setAccess}) => {
        ...
        <section className="welcome">
            ...
            <section className="main">
                <div className="top">
                    ...
                    <div className="right">
                        <PassRec notif={notif} setNotif={setNotif} access={access} setAccess={setAccess} cardClass={cardClass} setCardClass={setCardClass} size={size}/>
                    </div>
                </div>
